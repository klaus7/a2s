 ...
 * 
 * file:
 * "$URL: http://svn.openehr.org/ref_impl_java/TRUNK/libraries/src/java/org/openehr/am/archetype/constraintmodel/primitive/CDate.java $"
...
public final class CDate extends CPrimitive implements ICDateTime<DvDate> {
	 ...
	 *         or not null
	 */
	public CDate(final String pattern, final Interval<DvDate> interval, final List<DvDate> list,
					final DvDate assumedValue, final DvDate defaultValue) {
	 ...
	 */
	public CDate(final String pattern) {
	...
	private final DvDate defaultValue;
}
