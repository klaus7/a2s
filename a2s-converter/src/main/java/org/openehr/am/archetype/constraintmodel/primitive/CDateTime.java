 ...
 * 
 * file:
 * "$URL: http://svn.openehr.org/ref_impl_java/TRUNK/libraries/src/java/org/openehr/am/archetype/constraintmodel/primitive/CDateTime.java $"
...
public final class CDateTime extends CPrimitive implements ICDateTime<DvDateTime> {
	 ...
	 *         or not null
	 */
	public CDateTime(final String pattern, final Interval<DvDateTime> interval,
						final List<DvDateTime> list, final DvDateTime assumedValue,
						final DvDateTime defaultValue) {
	 ...
	 */
	public CDateTime(final String pattern) {
	...
	private final DvDateTime defaultValue;
}
