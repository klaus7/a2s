 ...
 * 
 * file:
 * "$URL: http://svn.openehr.org/ref_impl_java/TRUNK/libraries/src/java/org/openehr/am/archetype/constraintmodel/primitive/CDuration.java $"
...
public final class CDuration extends CPrimitive implements HasInterval<DvDuration> {
	 ...
	 */
	public CDuration(final DvDuration value, final Interval<DvDuration> interval,
						final DvDuration assumedValue, final String pattern, final DvDuration defaultValue) {
	...
	public CDuration(final DvDuration value, final Interval<DvDuration> interval,
						final DvDuration assumedValue, final String pattern) {
	...
	private final DvDuration defaultValue;
}
