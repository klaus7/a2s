 ...
 * 
 * file:
 * "$URL: http://svn.openehr.org/ref_impl_java/TRUNK/libraries/src/java/org/openehr/am/archetype/constraintmodel/primitive/CTime.java $"
...
public final class CTime extends CPrimitive implements ICDateTime<DvTime> {
	 ...
	 */
	public CTime(final String pattern, final Interval<DvTime> interval, final List<DvTime> list,
					final DvTime assumedValue, final DvTime defaultValue) {
	 ...
	 */
	public CTime(final String pattern) {
	...
	private final DvTime defaultValue;
}
